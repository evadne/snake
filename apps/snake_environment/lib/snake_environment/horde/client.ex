defmodule SnakeEnvironment.Horde.Client do
  @moduledoc """
  The Horde Client lives in Supervision trees elsewhere (for example under
  SnakeAccess.Supervisor), and is responsible for joining Hordes managed
  ...
  def init(target) do
    :ok = GenServer.call(SnakeEnvironment.Horde.Tracker, {:add_subscriber, self()})
